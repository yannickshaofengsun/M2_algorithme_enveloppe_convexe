...
L'algorithme **labeltri** produit à partir d'une matrice de points dans R^2 la matrice de points triée par le procédé expliqué plus haut. Il est de complexité O(n).
...
Enfin l'algorithme **dessin_env** permet d'afficher l'enveloppe convexe des points de R^2 sélectionés. Il est de complexité O(n).
